...
export function initEditorView(): () => void {
  ...
  function updateDaffodil() {
    ...
    (
      document.getElementById("firstWidthValue") as HTMLSpanElement
    ).textContent = params.firstPetals.width.toString();
    (
      document.getElementById("firstHeightValue") as HTMLSpanElement
    ).textContent = params.firstPetals.height.toString();
    (document.getElementById("secondEccValue") as HTMLSpanElement).textContent =
      params.secondPetals.eccentricity.toFixed(1);
    (
      document.getElementById("secondWidthValue") as HTMLSpanElement
    ).textContent = params.secondPetals.width.toString();
    (
    ...
    (
      document.getElementById("numScallopsValue") as HTMLSpanElement
    ).textContent = params.numScallops.toString();
    (
...
function saveSvg(container: HTMLElement) {
  const svg = container.querySelector("svg");
  if (!svg) return;
